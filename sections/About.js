...
const About = () => (
  <Container className="bg-white section p-4 mt-0 mb-5 rounded">
    ...
    <p>The International Conference on Lean and Agile Software Development (LASD) was established in 2017 as part of the FedCSIS multiconference. Over the years, the conference has evolved to adapt to changing circumstances and explore new opportunities. In 2021 and 2022, LASD was held as an online conference due to the COVID-19 pandemic, making it more accessible to a global audience. In 2023, it became a track within ACM SAC, and in 2024, LASD expanded its reach by being held twice — at SAC and at ISD — further establishing itself as a bridge between the Software Engineering and Information Systems communities.</p>
