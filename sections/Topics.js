...
const Topics = () => (
  <Container className="section p-4 bg-white my-5 rounded">
	...
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> LLMs and Agentic AI for improved efficiency</ListGroup.Item>
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Agile tools for AI-assisted software development and testing</ListGroup.Item>
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Agentic AI and autonomous coding assistants</ListGroup.Item>
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Human-AI collaboration in Agile teams</ListGroup.Item>
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Prompt engineering and AI integration in Agile workflows</ListGroup.Item>
	...
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Tailoring agile methods</ListGroup.Item>
	...
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Value stream management and flow-based delivery</ListGroup.Item>
	...
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Agile approaches for requirements engineering and UX research</ListGroup.Item>
	...
	<ListGroup.Item><i className="far fa-check-circle text-primary mr-3"/> Agile approaches for sustainable and green software development</ListGroup.Item>
    </ListGroup>
  </Container>
)
